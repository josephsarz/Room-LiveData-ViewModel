...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolder> {
    ...
    private List<Borrow> borrowModelList;
    private View.OnLongClickListener longClickListener;

    public RecyclerViewAdapter(List<Borrow> borrowModelList, View.OnLongClickListener longClickListener) {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        Borrow borrowModel = borrowModelList.get(position);
    ...
    public void addItems(List<Borrow> borrowModelList) {
        this.borrowModelList = borrowModelList;
